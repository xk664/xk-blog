...
![](/note/image/Screenshot 2026-01-11 202554.png)
...
![](/note/image/Screenshot 2026-01-18 165515.png)
...
![](/note/image/Screenshot 2026-01-23 151152.png)
...
![](/note/image/Screenshot 2026-01-22 202832.png)
...
![](/note/image/Screenshot 2026-01-23 142839.png)
...
![](/note/image/Screenshot 2026-01-23 170209.png)
...
- 原理
![](/note/image/Screenshot 2026-01-26 111437.png)
...
![](/note/image/Screenshot 2026-01-26 123121.png)
...
![](/note/image/Screenshot 2026-01-26 165501.png)
可中断指的是：可以被其他线程中断

## 基础语法
![](/note/image/Screenshot 2026-01-26 165810.png)
...
![](/note/image/Screenshot 2026-01-26 172837.png)
```java
//创建waitSet(休息室)
...
![](/note/image/Screenshot 2026-01-27 172134.png)
...
![](/note/image/Screenshot 2026-02-01 165617.png)
...
![](/note/image/Screenshot 2026-02-01 165751.png)

**SHUTDOWN:** 执行完队列里面的任务以后，所有线程都会被销毁
### 构造方法

![](/note/image/Screenshot 2026-02-01 170553.png)
...
![](/note/image/Screenshot 2026-02-01 173750.png)

### Executors.newCachedThreadPool()

![](/note/image/Screenshot 2026-02-01 174904.png)
...
![](/note/image/Screenshot 2026-02-01 175706.png)

**设置线程数量是实现类的接口，如果不加以装饰，则可以通过强转为ThreadPoolExecutor,然后调用setCorePoolSiz()方法

### 提交任务

![](/note/image/Screenshot 2026-02-01 202843.png)

### 关闭线程池

- shutDown()

![](/note/image/Screenshot 2026-02-01 205248.png)

**SHUTDOWN:** 执行完队列里面的任务以后，所有线程都会被销毁

- shutDownNow()
![](/note/image/Screenshot 2026-02-01 205618.png)
...
![](/note/image/Screenshot 2026-02-02 143747.png)

![](/note/image/Screenshot 2026-02-02 143422.png)

### Fork/Join线程池

- 概念
![](/note/image/Screenshot 2026-02-02 144047.png)
...
![](/note/image/Screenshot 2026-02-02 154031.png)
...
![](/note/image/Screenshot 2026-02-02 154425.png)

#### NonfairSync(阻塞队列中的线程会和非阻塞队列的线程竞争)

##### 获取/竞争锁原理

![](/note/image/Screenshot 2026-02-02 162030.png)
...
![](/note/image/Screenshot 2026-02-02 165445.png)
...
![](/note/image/Screenshot 2026-02-02 210240.png)
