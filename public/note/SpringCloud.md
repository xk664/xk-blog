...
![](/note/image/Screenshot 2026-02-07 162053.png)

### 常见注解

**注意：** 当成员属性是boolean类型的时候，且以is开头，mp会去掉is作为数据库中的字段名

![](/note/image/Screenshot 2026-02-07 163244.png)

## 核心功能 

### 条件构造器

![](/note/image/Screenshot 2026-02-07 165802.png)
...
![](/note/image/Screenshot 2026-02-08 151129.png)

### IService接口的基本使用
**IService接口里面声明了增删改查的各种方法，IServiceImpl中实现了IService接口中的大部分方法**

![](/note/image/Screenshot 2026-02-08 154954.png)

# Docker

![](/note/image/Screenshot 2026-02-08 203314.png)
...
![](/note/image/Screenshot 2026-02-10 204449.png)


### 注册步骤

![](/note/image/Screenshot 2026-02-10 212048.png)
### 服务发现

![](/note/image/Screenshot 2026-02-10 223610.png)
...
![](/note/image/Screenshot 2026-02-11 132210.png)
![](/note/image/Screenshot 2026-02-11 132522.png)
...
**开启连接池：**
![](/note/image/Screenshot 2026-02-11 140039.png)
...
![](/note/image/Screenshot 2026-02-11 202224.png)

### 路由规则
![](/note/image/Screenshot 2026-02-11 202724.png)

### 路由过滤器

指的是当请求到达网关的时候，给这个请求加上请求头，然后再转发给对应的微服务实例

![](/note/image/Screenshot 2026-02-11 205546.png)

#### GlobalFilter(全局过滤器)
对所有请求生效
![](/note/image/Screenshot 2026-02-11 213635.png)
...
**优势：** 
![](/note/image/Screenshot 2026-02-14 120236.png)
...
![](/note/image/Screenshot 2026-02-14 122405.png)
...
![](/note/image/Screenshot 2026-02-20 165054.png)
![](/note/image/Screenshot 2026-02-20 165223.png)

##### 熔断
![](/note/image/Screenshot 2026-02-20 173147.png)

### 分布式事务

![](/note/image/Screenshot 2026-02-20 205039.png)
...
![](/note/image/Screenshot 2026-02-21 105055.png)

- AT模式
**与XA不同的是，分支事务执行完之后会执行一个快照（undo log）,然后直接提交事务，当需要回滚的时候再根据快照回滚**

![](/note/image/Screenshot 2026-02-21 131010.png)
...
### 整体结构
![](/note/image/Screenshot 2025-12-04 220349.png)
**理解：**
...
![](/note/image/Screenshot 2025-12-06 113901.png)

### 消息转换器

![](/note/image/Screenshot 2025-12-07 130841.png)


![](/note/image/Screenshot 2025-12-07 130922.png)
...
![](/note/image/Screenshot 2025-12-07 133427.png)

### 生产者确认

![](/note/image/Screenshot 2025-12-07 134008.png)
...
![](/note/image/Screenshot 2025-12-07 153319.png)

### 消费者确认模式

![](/note/image/Screenshot 2025-12-07 154533.png)
...
![](/note/image/Screenshot 2025-12-08 103411.png)
延迟队列=死信交换机+TTL

成为死信的条件：
![](/note/image/Screenshot 2025-12-08 103719.png)
...
![](/note/image/Screenshot 2026-02-21 203334.png)

## 基本概念

![](/note/image/Screenshot 2026-02-21 205539.png)

## Mapping属性

![](/note/image/Screenshot 2026-02-21 210505.png)
...
![](/note/image/Screenshot 2026-02-21 210705.png)
### 查询索引库
...
![](/note/image/Screenshot 2026-02-21 211830.png)
...
![](/note/image/Screenshot 2026-02-21 222215.png)
...
![](/note/image/Screenshot 2026-02-22 143251.png)
...
![](/note/image/Screenshot 2026-02-22 150856.png)
...
![](/note/image/Screenshot 2026-02-22 151849.png)
